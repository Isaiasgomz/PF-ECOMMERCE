...
function Menu() {
  ...
  return <div className={styles.categories}>
    ...
    <Link to="/home"><button className={styles.buttons} onClick={()=>sortByCategory("componentes")}> <span className={styles.spanMenu}>Compnentes</span> <i className="fa-solid fa-screwdriver-wrench"></i> </button></Link>
