...
const { User, Product, QuantityProduct, Review, PersonalData, PurchaseOrder } = sequelize.models;
...
/* RELACION ENTRE PRODUCTO Y CANTIDAD */
Product.hasMany(QuantityProduct);
QuantityProduct.belongsTo(Product);
